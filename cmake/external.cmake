# TODO CLEAN THE SUPERBUILD:
#       - Remove the FetchContent from the external.cmake
#       - Put them into the superbuild (once and for all !)

set(LOG_PREFIX " [CT_ICP] -- ")
include(FetchContent)

if (SUPERBUILD_DIR)
    set(SUPERBUILD_CONFIG_FILE ${SUPERBUILD_DIR}/superbuild_import.cmake)
    message(INFO "${LOG_PREFIX}'SUPERBUILD_DIR' defined. Searching dependencies in the superbuild.")
    include(${SUPERBUILD_CONFIG_FILE})

    set(WITH_SUPERBUILD ON)
else ()

    message(INFO "${LOG_PREFIX}'SUPERBUILD_DIR' variable not defined. Building the dependencies.")
    set(WITH_SUPERBUILD OFF)
    ...
    if (NOT EIGEN_DIR)
        if (MSVC)
            ...
            set(EIGEN_DIR ${EXT_INSTALL_ROOT}/Eigen3/share/eigen3/cmake)
        endif ()
    endif ()
    if (MSVC)
